...
#                                                                              #
# It also has two subclasses added, ManagementStaff and BasicStaff             #
#                                                                              #
# It also overloads __add__ within the Staff class.                            #
#                                                                              #
#******************************************************************************#

# To run this program, start Python and then type:
# from class_demo4 import Staff
...
#-------------------------------------------------------------------------------
#
# ManagementStaff subclass of Staff
