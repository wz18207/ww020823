clear all;clc;
% 红葡萄酒质量评分数据
A=[79.95	75	80.45	78.15	76.25	71.95	75.85	71.85	76.65	77.05  71.85	67.84	69.9    74.55	75.4	70.65	79.55	74.9	74.3	77.2    77.8	75.2	76.65	74.7	78.3    77.8	70.9	80.45]; 
% 白葡萄酒质量评分数据
% A=[79.95	75	80.45	78.15	76.25	71.95	75.85	71.85	76.65	77.05   71.85	67.85	69.9	74.55	75.4	70.65	79.55	74.9	74.3	77.2     77.8	75.2	76.65	74.7	78.3	77.8	70.9]
X=A';
numC=7;
for i=1:numC
    kidx = kmeans(X,i);
