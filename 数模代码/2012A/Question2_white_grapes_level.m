...
A=result_report(:,(K+1));
[idx,ctr]=kmeans(A,4);
ctr=[76.531,77.564,74.592,76.677];
[m,n]=size(A);
t1=ones(1,n)*30;
...
disp('分类结果：');
disp(['第1类:' ,'中心点：',num2str(ctr(1)),'  ','该类样品编号：',num2str(C1(1,1:7))]);
disp(['第2类:' ,'中心点：',num2str(ctr(2)),'  ','该类样品编号：', num2str(C1(2,:))]);
disp(['第3类:' ,'中心点：',num2str(ctr(3)),'  ','该类样品编号：', num2str(C1(3,1:6))]);
disp(['第4类:' ,'中心点：',num2str(ctr(4)),'  ','该类样品编号：', num2str(C1(4,1:4))]);
